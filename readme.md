...
| Pattern | Description | Status |
|:-------:|:----------- |:------:|
| [Bridge](https://medium.com/@josueparra2892/bridge-pattern-in-go-2c11022c8fcb) | Decouples an interface from its implementation so that the two can vary independently | ✔ |
...
| Pattern | Description | Status |
|:-------:|:----------- |:------:|
| [Chain of Responsibility](https://medium.com/@achmadrizkinf/golang-pattern-chain-of-responsibility-db41f7d04372) | Avoids coupling a sender to receiver by giving more than object a chance to handle the request | ✔ |
